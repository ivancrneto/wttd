...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_media', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Media.title'
        db.alter_column('core_media', 'title', self.gf('django.db.models.fields.CharField')(max_length=2))
